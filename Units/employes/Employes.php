...
{   
    ...
    public function ChequesVacances(){
        ...
        {if($diff>=1){echo  $this->_Nom." ".$this->_Prenom." peut disposer de chèques vacances car il est la depuis au moins un an.";}
        else{echo  $this->_Nom." ".$this->_Prenom." est la depuis moins d'un an et ne peut donc pas disposer de chèques vacances.";}
    ...
    public function Restauration(){
        $vAgence = ($this->_Agence->_Restauration);
        if ($vAgence == "Restaurant"){echo "<script>console.log('L'agence de '.$this->_Nom.' '.$this->_Prenom.' dispose d'un restaurant.');</script>";}
        else if ($vAgence == "Tickets"){echo "<script>console.log('L'agence de '.$this->_Nom.' '.$this->_Prenom.' donne à ses employés des tickets restaurant.');</script>";}
...
var_dump($JackD->ChequesVacances());
var_dump($FranckI->ChequesVacances());
var_dump($AlainP->ChequesVacances());
var_dump($SarahD->ChequesVacances());
var_dump($RyanG->ChequesVacances());
